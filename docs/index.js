...
import screenFragmentShader from './shaders/screen.fragment.shader';
import bufferFragmentShader from './shaders/buffer.fragment.shader';
/**
 * Base
 */
// Scenes
...
const bufferMaterial = new THREE.ShaderMaterial({
    ...
    fragmentShader: bufferFragmentShader, // document.getElementById("fragmentShaderBuffer").textContent
});
//Screen Material
const quadMaterial = new THREE.ShaderMaterial({
    ...
    vertexShader: vertexShader, //document.getElementById("vertexShader").textContent,
    fragmentShader: screenFragmentShader, // document.getElementById("fragmentShaderScreen").textContent
});
// Meshes
...
const tick = () => {
    ...
    // renderBufferB = temp
    [renderBufferB, renderBufferA] = [renderBufferA, renderBufferB];
